...
**이 리스트는 "한국 경제/증시에 실질적으로 영향을 미치는" 뉴스여야 합니다.** 두 가지
유형을 모두 포함합니다:
(A) 주체가 한국인 기사 - 한국 정부, 한국 기업, 한국 시장(코스피/코스닥)이 직접 무엇을
    했다는 기사.
(B) 주체는 해외지만 한국 증시/산업에 직결되는 매크로·산업 동향 - 예: 미국 AI/반도체
    시장 흐름(삼성전자·SK하이닉스와 직결), 연준 금리 결정, 미국/중국 경기 지표,
    국제 유가·환율처럼 한국 경제 전반에 즉각 영향을 주는 큰 흐름.

**제외해야 할 것은 (B)가 아니라, 한국과 무관한 "제3국 개별 기업/사건" 단신입니다** -
예: "대만 기업 A가 미국에 투자한다", "日기업 B가 회사채를 발행했다", "中 기업 C가
실적을 냈다" 처럼, 그 기사 하나가 특정 해외 기업/국가에 국한되고 한국 시장 전반에
대한 매크로적 파급력이 없는 경우만 제외하세요. "AI 반도체株에 대한 월가 투자심리",
"미국 금리 인상이 신흥국 증시에 미치는 영향" 같은 기사는 (B)에 해당하므로 포함
대상입니다 - 주어가 미국/글로벌이라는 이유만으로 자동 제외하지 마세요.
...
5. 한국 증시/산업에 직결되는 해외 매크로 동향(위 B 유형) - 미국 AI/반도체 시장,
   연준 금리, 미·중 경기, 국제 유가·환율 등
...
사회공헌 활동, 특정 해외 기업 단독 소식 등 한국 시장 전반에 파급력이 없는 보도자료성
기사). 기사 제목에 "AI"라는 단어가 있다는 것만으로 경제 뉴스로 착각하지 마세요 -
"AI 영상이 화제" 같은 콘텐츠성 기사나, 한국과 무관한 특정 해외 스타트업의 AI 서비스
출시 소식은 위 5가지 기준에 해당하지 않으면 제외 대상입니다. 오늘 위 기준을 충족하는
기사가 ${DOMESTIC_NEWS_TOP_N}개보다 적다면, 그 개수만큼만 선정하고 억지로 채우지
마세요 - 기준 미달 기사로 채우는 것보다 적게 선정하는 것이 낫습니다.
