...
**이 리스트는 "한국"에 대한 뉴스여야 합니다.** 기사의 주된 주체(누가 무엇을 했는가)가
한국 정부, 한국 기업, 한국 시장(코스피/코스닥) 중 하나여야 선정 대상입니다. 대만/중국/
일본/미국 등 다른 나라의 정부·기업·시장이 주어인 기사는, 국내 언론사가 보도했더라도
제외하세요 - 예: "대만 기업들, 美에 투자", "中 증시 마감", "日기업 회사채 발행"은 전부
주체가 한국이 아니므로 제외 대상입니다. 예외는 그 해외 기사 자체에 "이는 한국의
OO에 어떤 구체적 영향을 미친다"는 내용이 실제로 명시된 경우뿐입니다(단순히 관련
업종이라는 이유로 끼워맞추지 마세요).

최대 ${DOMESTIC_NEWS_TOP_N}개의 기사를 선정하세요 - 이것은 상한이지 반드시 채워야 할
목표치가 아닙니다. 선정 기준(우선순위 순, 모두 주체가 한국이어야 함):
...
스포츠·연예 이슈), 위 4가지 기준과 무관한 개별 기업 단신(신제품 출시, 수상 소식,
사회공헌 활동 등 실질적 시장 파급력이 없는 보도자료성 기사), 국내 경제와 무관한
해외 인물/사건. 기사 제목에 "AI"라는 단어가 있다는 것만으로 경제 뉴스로 착각하지
마세요 - "AI 영상이 화제" 같은 콘텐츠성 기사는 위 4가지 기준에 해당하지 않으면 제외
