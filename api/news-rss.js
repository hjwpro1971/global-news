export default async function handler(req, res) {
    ...
    try {
        const rssUrls = [
            'https://news.google.com/rss/search?q=Semiconductor+Fed+FOMC+Economy+Korea+Market&hl=en-US&gl=US&ceid=US:en',
            'https://news.google.com/rss/search?q=%EA%B8%80%EB%A1%9C%EB%B2%8C+%EA%B2%BD%EC%A0%9C+%EC%A6%9D%EC%8B%9C+%EB%B1%98%EB%8F%84%EC%B2%B4+%ED%99%98%EC%9C%A8&hl=ko&gl=KR&ceid=KR:ko'
        ];
